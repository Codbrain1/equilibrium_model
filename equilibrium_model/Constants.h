...
namespace Partcile_Particle_model {
	...
	//initial conditions:
	//======================================================================
	const double N = 3; //число частиц
	const double t_0 = 0, t_1 = 130; //начальное и конеченое время
	const int div = 1000; //отвечает за частоту записи данных в файл 1=каждая итерация
	double dt = 0.0000001; //шаг времени
